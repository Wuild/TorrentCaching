...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <link rel="stylesheet" href="template/bootstrap/css/bootstrap-responsive.css" type="text/css" />
            ...
            <div class="container-narrow">
                <div class="masthead">
                    <ul class="nav nav-pills pull-right">
                        <li <?php echo (CURRENT_MODULE == "start" ? "class='active'" : "") ?>><a href="<?php echo URL; ?>">Home</a></li>
                        <li <?php echo (CURRENT_MODULE == "upload" ? "class='active'" : "") ?>><a href="<?php echo URL; ?>upload">Upload torrent</a></li>
                        <li <?php echo (CURRENT_MODULE == "documentation" ? "class='active'" : "") ?>><a href="<?php echo URL; ?>documentation">API Documentation</a></li>
